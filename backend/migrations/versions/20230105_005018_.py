...
Revision ID: 90845c7f00b8
Revises: 
Create Date: 2023-01-05 00:50:18.517020
...
def upgrade():
    ...
    sa.Column('buy_type', sa.String(length=255), nullable=False),
    sa.Column('stock_shares', sa.Float(), nullable=False),
    sa.Column('price_per_share_bought', sa.Float(), nullable=False),
